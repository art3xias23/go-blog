...
func jsScript() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<script src=\"/scripts/script.js\"></script><script src=\"/scripts/outputHTML.js\"></script>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
...
func navButtons() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<nav class=\"bg-gray-200 border-solid border-2 text-black w-full flex flex-row items-center px-3\"><div class=\"w-full flex justify-between\"><div id=\"left-nav\" class=\"w-8\"><img src=\"/img/baby.png\" alt=\"bby_image\" class=\"block rounded-full h-auto w-14\"></div><div id=\"center-nav\" class=\"w-4/5 hidden sm:flex sm:justify-between sm:items-center\"><a class=\"text-lg cursor-pointer\" hx-get=\"/posts\" hx-push-url=\"true\" hx-target=\"main\" hx-indicator=\"#spinner\">Posts</a> <a class=\"text-lg cursor-pointer\" hx-get=\"/letterboxd\" hx-push-url=\"true\" hx-target=\"main\" hx-indicator=\"#spinner\">Letterboxd</a> <a class=\"text-lg cursor-pointer\" hx-get=\"/goodreads\" hx-push-url=\"true\" hx-target=\"main\" hx-indicator=\"#spinner\">Goodreads</a> <a class=\"cursor-pointer\" href=\"mailto:konstantin.v.milchev@gmail.com\"><i class=\"fa-solid fa-envelope fa-2xl\"></i></a> <a class=\"cursor-pointer\" href=\"https://github.com/art3xias23\"><i class=\"fa-brands fa-github-alt fa-2xl\"></i></a></div></div><div id=\"openmenu\" class=\"sm:hidden left-0\"><i class=\"fa-solid fa-bars\"></i></div></nav>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
...
func footer() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<footer><div style=\"text-align: center; padding: 20px;\"><p>© 2024 Pragmatino Soft. All rights reserved.</p></div></footer>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
...
func title(title string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/layout.templ`, Line: 141, Col: 14}
		}
